...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    renderSlot(_ctx.$slots, "default", {}, () => [
      $props.label ? (openBlock(), createElementBlock("span", mergeProps({
        key: 0,
        class: "p-avatar-text"
      }, _ctx.ptm("label")), toDisplayString($props.label), 17)) : _ctx.$slots.icon ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.$slots.icon), mergeProps({
        key: 1,
        class: "p-avatar-icon"
      }, _ctx.ptm("icon")), null, 16)) : $props.icon ? (openBlock(), createElementBlock("span", mergeProps({
        key: 2,
        class: ["p-avatar-icon", $props.icon]
      }, _ctx.ptm("icon")), null, 16)) : $props.image ? (openBlock(), createElementBlock("img", mergeProps({
        key: 3,
        src: $props.image,
        alt: _ctx.ariaLabel,
...
// dep:primevue_avatar
var primevue_avatar_default = script2;
export {
  primevue_avatar_default as default
};
