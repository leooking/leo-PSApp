...
var _hoisted_1$1 = ["id", "aria-label", "aria-selected", "aria-expanded", "aria-level", "aria-setsize", "aria-posinset"];
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    createBaseVNode("span", mergeProps({ class: $options.labelClass }, _ctx.ptm("label")), [
        ...
        createVNode(Transition, {
          ...
          default: withCtx(() => [
            $data.overlayVisible ? (openBlock(), createElementBlock("div", mergeProps({
              ...
              createBaseVNode("div", mergeProps({ class: "p-cascadeselect-items-wrapper" }, _ctx.ptm("wrapper")), [
...
// dep:primevue_cascadeselect
var primevue_cascadeselect_default = script6;
export {
  primevue_cascadeselect_default as default
};
